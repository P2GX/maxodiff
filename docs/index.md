...
We implement maxodiff as a Java application that can be run as a stand-alone command line app or can be accessed from our Webserver 
!!! danger "🚨 TODO"
    <span class="todo-pulse">Add link to webserver when it is running</span>
