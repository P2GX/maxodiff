...
import org.monarchinitiative.maxodiff.html.config.MaxodiffConfiguration;
...
public class MaxodiffConfigurationTest extends AbstractConfigurationTest {

    @Test
    public void testMissingDataPath() {
        Throwable thrown = assertThrows(BeanCreationException.class, () -> load(MaxodiffConfiguration.class));
    ...
    public void testBadDataPath() {
        Throwable thrown = assertThrows(BeanCreationException.class, () -> load(MaxodiffConfiguration.class, "maxodiff.dataDirectory=path/to/junk"));
    ...
    public void testDataPath() {
        load(MaxodiffConfiguration.class, "maxodiff.dataDirectory=" + TEST_DATA);
    ...
    public void testWeCanOverrideVaPropertyValues() {
        load(MaxodiffConfiguration.class,
